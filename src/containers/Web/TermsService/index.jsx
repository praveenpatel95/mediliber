                        ...
                        <Row>
                            <Col sm={3}>
                                <ListGroup className="simple-list sticky-top" style={{'top': '120px'}}>
                                    ...
                                    <ListGroup.Item as="a" href="#become_editor">Introduction</ListGroup.Item>
                                    <ListGroup.Item as="a" href="#resources">General availability of the Site</ListGroup.Item>
                            ...
                            <Col sm={9} className="pe-5 text-justify">
                                ...
                                <article id="resources" className="mb-5">
                                    <h2>General availability of the Site</h2>
                                    <p>
                                        It is a long established fact that a reader will be distracted by the readable
                                        content of a page when looking at its layout. The point of using Lorem Ipsum is
                                        that it has a more-or-less normal distribution of letters, as opposed to using
